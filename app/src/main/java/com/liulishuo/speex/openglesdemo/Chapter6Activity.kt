...
class Chapter6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(LocalGLSurfaceView6(this))
    }
}

private class LocalGLSurfaceView6 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    GLSurfaceView(context, attrs) {
    init {
        setEGLContextClientVersion(2)
        setRenderer(LocalRender6())
        renderMode = RENDERMODE_WHEN_DIRTY
    }
}

private class LocalRender6 : GLSurfaceView.Renderer {
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES20.glDrawElements(
            ...
            GLUtil.createShortBuffer(vertexIndex)
        )
    }
