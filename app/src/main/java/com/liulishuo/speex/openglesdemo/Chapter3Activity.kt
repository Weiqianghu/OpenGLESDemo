...
class Chapter3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(LocalGLSurfaceView3(this))
    }
}

private class LocalGLSurfaceView3 @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    GLSurfaceView(context, attrs) {
    init {
        setEGLContextClientVersion(2)
        setRenderer(LocalRenderer3())
...
private class LocalRenderer3 : GLSurfaceView.Renderer {
